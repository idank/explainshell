tests:
	pytest --doctest-modules tests/test-*.py tests/test_*.py explainshell/ --deselect=tests/test-e2e.py
...
test-llm:
	RUN_LLM_TESTS=1 pytest tests/test-llm-extractor.py::TestRealLlm -v
